...
const insultMessages = [
  ...
  "{target} senin aklınla ancak tavuk beslenir!",
  "{target} pislik topu!",
  "{target} sen SALAKSIN!",
  "{target} ağzını açınca IQ’m düşüyor!",
  "{target} sil şu oyunu ezik!",
  "{target} beynini söğüş yapıp yemiş...",
  "{target} seninle aynı oksijeni tüketmek zulüm!",
  "{target} göt kadar aklın var!",
  "{target} götünden uyduruyorsun yine!",
  "{target} senin gibi mal görmedim!",
  "{target} git köşende ağla!",
  "{target} seninle aynı gezegende yaşamak utanç verici!",
  ...
  "{target} beynini tuvalete düşürmüşsün galiba!",
