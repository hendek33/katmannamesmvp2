      ...
      <div className="relative z-10 h-full flex flex-col p-2 animate-in fade-in duration-500">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[180px_1fr_180px] xl:grid-cols-[200px_1fr_200px] gap-2 flex-1 min-h-0">
          ...
          <div className="flex flex-col min-h-0 flex-1 gap-1 items-center justify-center p-1 lg:p-2 relative">
            ...
            <div className="grid grid-cols-5 gap-[1px] sm:gap-[2px] md:gap-1 lg:gap-1.5 xl:gap-2 w-full max-w-[600px] md:max-w-[700px] lg:max-w-[800px] xl:max-w-[900px] 2xl:max-w-[1000px] mb-24" 
