...
export default function Game() {
  ...
  return (
    <div className="h-screen overflow-hidden bg-slate-900" style={{ backgroundImage: 'url(/arkaplan.png)', backgroundSize: '75%', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
