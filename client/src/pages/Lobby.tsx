...
export default function Lobby() {
  ...
  return (
    <div className="min-h-screen p-4 bg-slate-900 animate-in fade-in duration-500" style={{ backgroundImage: 'url(/arkaplan.png)', backgroundSize: '75%', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
